package com.github.drr00t.lakehouse.configuration;
...
// https://github.com/apache/camel/blob/main/components/camel-debezium/camel-debezium-common/camel-debezium-common-component/src/main/java/org/apache/camel/component/debezium/configuration/ConfigurationValidation.java
    ...
    public static ConfigurationValidation notValid(final String reason) {
        if (ObjectHelper.isEmpty(reason)) {
            throw new IllegalArgumentException(
                    "You will need to specify a reason why is not valid");
        }
